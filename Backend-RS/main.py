...
from routers.amistades import router as amistades_router  
...
app.include_router(amistades_router, prefix="/api", tags=["amistades"])  
...
from routers.comentarios import router as comentarios_router
from routers.amistades import router as amistades_router  
from routers.recomendacion import router as recomendaciones_router  # Agregar el router de Recomendaciones
...
app.include_router(comentarios_router, prefix="/api", tags=["comentarios"])
app.include_router(amistades_router, prefix="/api", tags=["amistades"])  
app.include_router(amistades_router, prefix="/api", tags=["amistades"])  # Asegúrate de incluir amistades_router aquí
app.include_router(recomendaciones_router, prefix="/api", tags=["recomendaciones"])  # Agregar el router de Recomendaciones
